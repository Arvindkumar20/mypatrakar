...
//                     className="block text-sm font-medium text-gray-700 mb-1"
//                   >
//                     Regitarion Type <span className="text-red-500">*</span>
//                   </label>
//                   <input
//                     type="text"
...
//                       }`}
//                     >
//                       {validation.errors.registration_type || "RNI OR MIB"}
//                     </p>
//                     {/* <p className="text-xs text-gray-500">
//                       {formData.app_name.length}/30
//                     </p> */}
...
//                     className="block w-full px-3 py-3 border border-gray-300 bg-gray-50 rounded-md shadow-sm sm:text-sm "
//                   />
//                   <p className="mt-1 text-xs text-gray-500">
