...
export const GetRepoters = (() => async () => await API.post("/reporters-uses-my-patrakar", {}, {
    headers: {
        'Authorization': AuthToken
    }
}));

export const GetFeature = async () => await API.post("/features-in-my-patrakar", {}, {
    headers: {
        'Authorization': AuthToken
    }
...
export const getSates = async () => await API.post(`/getStates`, { name: "India" }
    , {
        headers: {
            'Authorization': AuthToken
        }
...
export const getCitiesBySates = async (name) => await API.post(`/getCities`, {
    name: name
}
    , {
        headers: {
...
export const getPurchaseDetails = async (purchase_id) => await API.post(`/purchased-details`, {
...
export const makePayment = async (data) => await API.post(`/make-payment`, {
