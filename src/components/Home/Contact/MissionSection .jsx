    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 -z-20">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 lg:gap-20">
        ...
        <div className="relative bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-xl p-8 border border-gray-100 transform transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl -z-20">
          <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-blue-500 to-purple-600 rounded-t-2xl -z-10"></div>
          ...
          <div className="relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full"></div>
        ...
        {/* Mission Card */}
        <div className="relative bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-xl p-8 border border-gray-100 transform transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl  -z-20">
          <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-red-500 to-orange-500 rounded-t-2xl"></div>
          ...
          <div className="relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-gradient-to-r from-red-400 to-orange-400 rounded-full"></div>
            <p className="text-gray-600 text-lg leading-relaxed text-center">
              {t("contact.missionDesc")}
            </p>
          </div>
