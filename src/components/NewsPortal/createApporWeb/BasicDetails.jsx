...
//     if (name === "app_logo" || name === "web_logo") {
...
//       <section>
//         <h2 className="font-semibold text-xl my-4 text-gray-800">Basic Details</h2>
...
//             label="Owner Name"
//             name="owner_name"
//             placeholder="JITENDRA DEEPAK MOTE"
...
//             name="owner_email"
//             placeholder="sachchaikisoch@gmail.com"
...
//             label="Address"
//             name="owner_add"
//             placeholder="10/8/1, near Arvindo Park Road, Sector 10, Indira Nagar, Lucknow"
...
//         <option key={opt.id || index} value={opt.name || opt}>
//           {opt.name || opt}
//         </option>
//       ))}
//     </select>
