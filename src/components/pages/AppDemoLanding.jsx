        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="mt-6 text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
              Don't just imagine it. Download our app and experience a real-time
              demo of your own fully branded news application. Customize colors,
              fonts, and layouts instantly.
            </p>
            {/* <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center"> */}
            {/* <button className="w-full sm:w-auto px-8 py-4 bg-[#FE0101] text-white rounded-xl font-bold text-lg hover:bg-[#d60000] transition shadow-xl hover:shadow-2xl hover:-translate-y-1 flex items-center justify-center gap-3">
                <Play className="fill-current w-5 h-5" />
                Download App from Play Store
              </button>
              <button className="w-full sm:w-auto px-8 py-4 bg-blue-900 text-white rounded-xl font-bold text-lg hover:bg-blue-800 transition shadow-xl hover:shadow-2xl hover:-translate-y-1 flex items-center justify-center gap-3">
                <Play className="fill-current w-5 h-5" />
                Available for Android & iOS Devices
              </button> */}

            {/* <div className="w-full sm:w-1/3 h-[80px]   text-white rounded-xl font-bold text-lg  transition shadow-xl hover:shadow-2xl hover:-translate-y-1 flex items-center justify-center gap-3">
                <img src={googlePlay} alt="Google Play Store" className="w-full h-full rounded-xl"/>
              </div>
              <div className="w-full sm:w-1/3 h-[80px]   text-white rounded-xl font-bold text-lg  transition shadow-xl hover:shadow-2xl hover:-translate-y-1 flex items-center justify-center gap-3">
                <img src={googlePlay} alt="Google Play Store" className="w-full h-full rounded-xl"/>
              </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                ...
                typography, language, and theme color — and see changes applied
                instantly.
              </p>
      ...
      <section className="py-24 bg-[#16274F] text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
            Download the MyPatrakar app, enable Demo Mode, and watch your brand
            come alive in seconds.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row gap-6 justify-center items-center">
            {/* Google Play Button */}
            <a
